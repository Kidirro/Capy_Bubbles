...
namespace BubbleShooterGameToolkit.Scripts.CommonUI.Popups
{
	public class BoostShop : PopupWithCurrencyLabel
	{
		...
		public void SetBoost(BoostParameters param, Action buyCallback = null)
		{
			...
			Debug.Log(param.title);
			title.text = LocalizeStorage.GetText(param.title, LocalizationChanger.language);
			description.text = LocalizeStorage.GetText(param.description, LocalizationChanger.language);
