...
{
    public class Gem : ResourceObject
    {
        protected override string ResourceName => "Gem";
        public override int DefaultValue => Resources.Load<GameSettings>("Settings/GameSettings").gem;
