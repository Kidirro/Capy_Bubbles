...
namespace BubbleShooterGameToolkit.Scripts.Gameplay.Managers
{
    ...
    public class ColorManager : Singleton<ColorManager>
    {
        ...
        private void CorrectColors()
        {
            ...
            var allColorBalls = GameObject.FindObjectsByType<ColorBall>(FindObjectsSortMode.None).Where(i => i != null && i.gameObject.activeSelf && (i.Flags & EBallFlags.Pinned) != 0);
        ...
        {
            var count = GameObject.FindObjectsByType<ColorBall>(FindObjectsSortMode.None).Where(i => i != null && i.gameObject.activeSelf && (i.Flags & EBallFlags.Pinned) != 0 && i.GetColor() == color).Count();
            return count;
        }
